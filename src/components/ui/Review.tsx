  ...
  return (
    <section className="py-10 md:py-14 lg:py-18 bg-gray-50">
      <div className="container mx-auto px-4">
        <motion.div
          className="relative bg-white rounded-3xl shadow-lg p-8 md:p-12  overflow-hidden"
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-32 md:w-64 h-32 md:h-64 bg-purple-200 rounded-br-full"></div>
