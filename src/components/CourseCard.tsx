...
export default function CourseCard({ course }: CourseCardProps) {
  ...
  const handleCardClick = () => {
    router.push(getCourseRoute(course));
  };
  ...
  return (
    <>
      <div
        ...
        className="block max-w-md w-full bg-slate-50 rounded-3xl overflow-hidden shadow-lg border border-slate-100 relative group hover:shadow-xl transition-shadow duration-300 cursor-pointer select-none focus:outline-none focus:ring-2 focus:ring-purple-500"
      >
