...
interface RiseAndThriveDocumentaryProps {
  videoId?: string;
  libraryId?: string;
...
export default function RiseAndThriveDocumentary({
  videoId = "edb947b6-4c94-4e57-bcd7-cd996528875d",
  libraryId = "738203",
  standaloneUrl = "https://player.mediadelivery.net/play/738203/edb947b6-4c94-4e57-bcd7-cd996528875d",
  title = "Documentary",
}: RiseAndThriveDocumentaryProps) {
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 py-3.5 bg-slate-50 border-b border-slate-200">
                <div className="flex items-center gap-2 text-sm font-semibold text-slate-800">
                  <Film className="w-4 h-4 text-purple-600" />
                  <span>Rise & Thrive Documentary</span>
                </div>
              ...
              <div className="relative aspect-video w-full bg-black">
                <iframe
                  src={theaterEmbedUrl}
                  title="Rise & Thrive Documentary - Theater Mode"
                  className="absolute inset-0 w-full h-full border-0"
                  allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture"
                  allowFullScreen
                />
